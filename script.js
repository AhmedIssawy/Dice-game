...
if (randomNumber1 === randomNumber2) { // if dice1=dice2 will print DRAW!
    document.querySelector("h1").innerText = "DRAW!!";
}
else if(randomNumber1 > randomNumber2){ // if dice1>dice2 will print 🚩Player 1 WINS
    document.querySelector("h1").innerText = "🚩Player 1 WINS";
}
else{document.querySelector("h1").innerText = "Player 2 WINS🚩";} //if dice1<dice2 will print 🚩Player 1 WINS
